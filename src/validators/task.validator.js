...
// Schema untuk FULL UPDATE (PUT /tasks/:id)
...
// Schema untuk PARTIAL UPDATE (PATCH /tasks/:id)
...
const listTasksSchema = Joi.object({
  ...
  priority: Joi.string().valid(...VALID_PRIORITY).optional(), // Sudah diperbaiki dari 'ty' menjadi 'priority'
